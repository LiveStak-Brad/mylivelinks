-- ============================================================================
-- Add hide_streaming_stats to RPC function
-- ============================================================================
...
DECLARE
    ...
    v_result JSON;
BEGIN
    -- Get profile data (including social media AND hide_streaming_stats)
    SELECT 
        p.id,
        p.username,
        p.display_name,
        ...
        p.hide_streaming_stats,  -- Added this field
        -- Social media fields
        p.social_instagram,
        p.social_twitter,
        p.social_youtube,
...
COMMENT ON FUNCTION get_public_profile_with_adult_filtering IS 'Fetch profile with adult link filtering, social media fields, and hide_streaming_stats preference.';

-- Success message
SELECT 'RPC function updated to include hide_streaming_stats!' AS status;
