-- ============================================================================
-- FIX v2: rpc_get_team_chat_messages - Fix type mismatch for author_role
-- ============================================================================
-- Fixes error: "Returned type character varying(50) does not match expected type text"
-- ============================================================================
...
BEGIN
  ...
  SELECT
    ...
    CAST(wr.role AS text) AS author_role,  -- FIX: Explicit CAST for enum type
...
-- Done!
SELECT 'Team chat RPC fixed - type mismatch resolved' AS result;
