-- ============================================================================
-- Update RPC Function to Include Social Media and Display Preferences
-- ============================================================================
-- This updates the get_public_profile_with_adult_filtering function
-- to include social media fields and display preferences
-- ============================================================================
...
DECLARE
    ...
    v_result JSON;
BEGIN
    -- Get profile data WITH social media fields and display preferences
    SELECT 
        p.id,
        p.username,
        p.display_name,
    ...
    WHERE ul.profile_id = v_profile.id 
      ...
      AND (ul.is_adult = FALSE OR ul.is_adult IS NULL);
    ...
    FROM friends WHERE user_id_1 = v_profile.id OR user_id_2 = v_profile.id;
    ...
    FROM (
        ...
        FROM gifts g JOIN profiles p ON p.id = g.sender_id
    ...
    FROM (
        ...
        FROM stream_stats ss JOIN profiles p ON p.id = ss.profile_id
...
-- 
-- What was updated:
-- ✅ Added all 12 social media fields to the SELECT
-- ✅ Added hide_streaming_stats display preference
-- ✅ Social media icons will now appear on profiles!
-- ✅ Links-only mode will work properly
--
-- After running this:
-- - Social media buttons will show up on profiles
-- - Display preferences will be respected
-- ============================================================================
