-- ============================================================================
-- NUCLEAR OPTION: Drop and recreate the function completely fresh
-- ============================================================================
-- This ensures NO old versions are cached or causing conflicts
-- ============================================================================
...
DROP FUNCTION IF EXISTS get_public_profile_with_adult_filtering(text, uuid) CASCADE;
DROP FUNCTION IF EXISTS get_public_profile_with_adult_filtering(text) CASCADE;

-- 2. CREATE the function fresh (KNOWN WORKING VERSION)
...
DECLARE
    ...
    v_result JSON;
BEGIN
    -- Get profile data (ONLY COLUMNS THAT EXIST)
    SELECT 
        p.id,
        p.username,
        p.display_name,
