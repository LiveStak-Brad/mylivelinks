/**
 * Profile Section Types + Empty State Copy (WEB)
 *
 * IMPORTANT:
 * - This file previously contained mock data providers (dummy content).
 * - All UI components must render real data only; if unavailable, show empty states.
...
// ============================================================================
// SECTION DATA TYPES (REAL DATA SHAPES)
// ============================================================================
 ...
 */
export function getEmptyStateText(section: string, profileType?: ProfileType): { title: string; text: string; ownerCTA?: string } {
