-- ============================================================================
-- FIX: Drop BOTH conflicting function versions and create ONE correct version
-- ============================================================================

-- Drop BOTH versions (text and character varying)
DROP FUNCTION IF EXISTS get_public_profile_with_adult_filtering(text, uuid, text) CASCADE;
DROP FUNCTION IF EXISTS get_public_profile_with_adult_filtering(character varying, uuid, character varying) CASCADE;
