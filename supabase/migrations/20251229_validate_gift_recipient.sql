-- ============================================================================
-- CRITICAL FIX: Add recipient validation to send_gift_v2
-- ============================================================================
-- Prevents exploit where malicious client could change recipient ID
-- to send gifts to arbitrary users instead of the intended artist.
-- ============================================================================
...
BEGIN
  ...
  -- ⚠️ CRITICAL FIX: Validate recipient exists
  -- Prevents sending gifts to arbitrary/non-existent user IDs
...
COMMENT ON FUNCTION public.send_gift_v2 IS 'Send gift with recipient validation. Prevents sending to invalid/arbitrary user IDs. 1:1 coins->diamonds, idempotent via request_id.';
