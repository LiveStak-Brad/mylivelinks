-- ============================================================================
-- Fix get_leaderboard ambiguous function error
-- ============================================================================
-- There are conflicting signatures with p_room_id as uuid vs text.
-- This migration drops ALL versions and creates a single canonical one.
-- ============================================================================

BEGIN;

-- Drop ALL existing signatures to eliminate ambiguity
...
-- Create single canonical function with text room_id (more flexible for API calls)
-- and includes is_mll_pro in the return
