...
-- P0: Ensure pool gifts count in global leaderboards exactly like normal gifts.
-- Authoritative source is ledger_entries; pool gifts write distinct entry_type values.
-- We only extend the canonical 4-arg get_leaderboard RPC to include those types.
