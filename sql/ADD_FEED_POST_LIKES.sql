-- ============================================================================
-- Feed Post Likes System
-- ============================================================================
-- Adds like functionality to posts and post_comments
-- User can like once per post/comment (no unlike)
-- Counters cached on posts table for performance
-- ============================================================================
...
-- ============================================================================
-- Stores notifications for likes, comments, follows, gifts, etc.
-- ============================================================================
...
-- Test like a post:
-- SELECT * FROM rpc_like_post('your-post-id'::uuid, auth.uid());

-- Test like a comment:
-- SELECT * FROM rpc_like_comment('your-comment-id'::uuid, auth.uid());
