-- ============================================================================
-- SAFER UPDATE: get_public_profile_with_adult_filtering
-- ============================================================================
-- This version only adds fields that definitely exist
-- Run AFTER the color customization migration
-- ============================================================================
...
DECLARE
    ...
    v_result JSON;
BEGIN
    -- Get profile data - START WITH JUST THE CRITICAL ADDITIONS
    SELECT 
        p.id,
        p.username,
        p.display_name,
        ...
        p.enabled_modules,             -- ADDED - THE KEY FIX!
