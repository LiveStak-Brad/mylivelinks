-- ============================================================================
-- UPDATE: get_public_profile_with_adult_filtering - Add missing fields
-- ============================================================================
-- Adds enabled_modules, enabled_tabs, and color customization fields
-- ============================================================================
...
DECLARE
    ...
    v_result JSON;
BEGIN
    -- Get profile data (NOW INCLUDING enabled_modules, enabled_tabs, and color fields!)
    SELECT 
        p.id,
        p.username,
        p.display_name,
        ...
        p.total_gifts_sent,
        p.gifter_level,
        p.profile_type,                -- ADDED
        p.enabled_modules,             -- ADDED - THIS IS THE KEY ONE!
        p.enabled_tabs,                -- ADDED
        p.profile_bg_url,
        ...
        p.font_preset,
        p.accent_color,
        p.button_color,                -- ADDED
        p.content_text_color,          -- ADDED
        p.ui_text_color,               -- ADDED
        p.link_color,                  -- ADDED
        p.links_section_title,
        p.hide_streaming_stats,
        p.show_top_friends,            -- ADDED (if it exists)
        p.top_friends_title,           -- ADDED (if it exists)
        p.top_friends_avatar_style,    -- ADDED (if it exists)
        p.top_friends_max_count,       -- ADDED (if it exists)
        -- Social media fields
        p.social_instagram,
        p.social_twitter,
        p.social_youtube,
...
-- ============================================================================
-- The RPC now returns:
-- - enabled_modules (array) - Your custom module selections!
-- - enabled_tabs (array) - Your custom tab selections!
-- - profile_type - Your profile type
-- - button_color, content_text_color, ui_text_color, link_color - Color customizations!
-- - show_top_friends, top_friends_title, etc. - Top friends settings
--
-- After running this, refresh your profile and it should respect your settings!
-- ============================================================================
