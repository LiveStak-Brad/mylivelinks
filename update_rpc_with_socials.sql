-- ============================================================================
-- Update get_public_profile_with_adult_filtering to include social media
-- ============================================================================
...
COMMENT ON FUNCTION get_public_profile_with_adult_filtering IS 'Fetch profile with adult link filtering and social media fields. Adult links only returned if viewer is eligible (18+, web, consent).';
